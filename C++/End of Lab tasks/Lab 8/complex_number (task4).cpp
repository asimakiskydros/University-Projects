...
double & complex_number::operator[](int index){
	if(index==0)
		return this->a;
	else
		return this->b;
...
complex_number &operator/(const complex_number &obj1,const complex_number &obj2){
	complex_number *newobj=new complex_number;
	double denominator=obj2.getA()*obj2.getA()+obj2.getB()*obj2.getB();
	newobj->setA((obj1.getA()*obj2.getA()+obj1.getB()*obj2.getB())/denominator);
	newobj->setB((obj1.getB()*obj2.getA()-obj1.getA()*obj2.getB())/denominator);
	return *newobj;
}